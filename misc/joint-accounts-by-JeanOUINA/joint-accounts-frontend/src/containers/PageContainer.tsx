...
import { LanguageIcon, SunIcon, MoonIcon, ComputerDesktopIcon } from '@heroicons/react/24/outline';
...
const PageContainer = ({
	...
	const themes: [typeof SunIcon, string][] = [
		[SunIcon, i18n?.light],
		[MoonIcon, i18n?.dark],
		[ComputerDesktopIcon, i18n?.system],
	];
	...
	return !i18n ? null : (
		<div className="h-0 min-h-screen relative flex flex-col">
					...
					<DropdownButton
						buttonJsx={
							<div className="w-8 h-8 xy">
								<LanguageIcon className="text-skin-muted w-7 h-7" />
							</div>
						}
						dropdownJsx={
							<>
			...
			<div className="fx justify-end gap-2 mx-4 my-3 text-skin-muted text-sm">
				...
				<A href="https://github.com/JeanOUINA/joint-accounts-frontend" className="brightness-button">
					GitHub
				</A>
